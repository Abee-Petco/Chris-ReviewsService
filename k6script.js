...
// export default function () {
//   const res = http.get(`http://127.0.0.1:3001/averageReviews/${Math.ceil(Math.random() * 10000000 + 100)}`);
...
// export default function () {
//   const res = http.get(`http://127.0.0.1:3001/averageReviews/${Math.ceil(Math.random() * 1000 + 9999100)}`);
...
// export default function () {
//  const res = http.get(`http://127.0.0.1:3001/averageReviews/array${idStrings[Math.floor(Math.random() * 1000)]}`);
